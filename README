...
1) Viewport/camera setup, with frustum culling support to draw only what is visible within the scene.
...
3) Some viable old legacy Flash/Alternativa3D 7 code to port over to HTML/CSS for viewing on mobile broswers.
