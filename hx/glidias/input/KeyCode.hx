/**
 * Keycode table for all values between 0 - 255;
 * @author Glenn Ko
 */
...
class KeyCode 
{
    ...
    public static inline var APPLICATION_KEY:UInt = 93;
    ...
    public static inline var PRINT_SCREEN:UInt = 124;
	...
	/*
    public static inline var LEFT_SHIFT:UInt = 1000;
    public static inline var RIGHT_SHIFT:UInt = 1001;
    public static inline var LEFT_CTRL:UInt = 1002;
    public static inline var RIGHT_CTRL:UInt = 1003;
    public static inline var LEFT_ALT:UInt = 1004;
    public static inline var RIGHT_ALT:UInt = 1005;
	*/
